provider "google" {
  project = "monte-carlo-estimation-testing"
  region  = "europe-west3"
}
...
resource "google_storage_bucket" "function_bucket" {
  name     = "monte-carlo-estimation-test-v1"
...
resource "google_cloudfunctions_function" "cloud_function" {
  name                  = "json_terraform_gcp_function_monte_carlo"
  description           = "Cloud Function for executing Monte Carlo simulations"
  runtime               = "nodejs20"
