...
resource "aws_lambda_function" "lambda" {
  ...
  function_name = "json_terraform_lambda_eratosthenes"
...
resource "aws_api_gateway_rest_api" "api" {
  name        = "json_terraform_eratosthenes_api"
  description = "API for Lambda Function used to test Eratosthenes simulations"
}
